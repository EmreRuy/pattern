...
data class ExtendedColors(
    val habitCardBackground: Color
)

val LocalExtendedColors = staticCompositionLocalOf {
    ExtendedColors(
        habitCardBackground = Color.Unspecified
    )
}
...
fun AppTheme(
    ...
    val extendedColors = ExtendedColors(
        habitCardBackground = if (darkTheme) colorScheme.surfaceContainerLow else colorScheme.surfaceContainerLowest
    )
